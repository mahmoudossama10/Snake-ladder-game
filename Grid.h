...
public:
	...
	GameObject* HasGameObject(CellPosition A); // To Check If A Cell With The Cell Position A Has A GameObject Or Not
	...
	bool IsOverLapping(GameObject* newObj); // Checks If A New Game Object Will OverLap Another Existing One
	Player** GetNextPlayer(CellPosition CurrentPos , int &numPlayers);  // Gets a Pointer to the first player after the passed "CurrentPos"
	...
	void SaveAll(GameObject** GO);      // This Function Upload All The GameObjects In The Cell List In The GameObject Array Of Pointers Sent As A Parameter


	void ClearAllObjects(); // Clear All Objects From The Grid.
	                        // We Will Use This Function In Open Grid Action In Order To Delete All Objects If The User Wants To Open Another Grid
