...
class Cell
{
	...
	Player* P[4];                   // Pointer To The Players That Is One The Cell
...
public:
	...
	void Addplayertocell(Player* P1 , int PlayerNum); // Adds Player To The Cell
	void Removeplayerfromcell(int PlayerNum); // Removes Player From The Cell
	Player** HasPlayer(int & num);          // Checks if the cell has one of the 4 players or not
	// ======= Drawing Functions ======= 
